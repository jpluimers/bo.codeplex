...
// FullDebugModeCallBacks enables FullDebugMode
...
type
  TOnDebugGetMemFinish = procedure (const AAllocatedFullDebugBlockHeader: PFullDebugBlockHeader; const ASize: Integer);
  TOnDebugFreeMemStart = procedure (const AToFreeFullDebugBlockHeader: PFullDebugBlockHeader);
  TOnDebugFreeMemFinish = procedure (const AFreedFullDebugBlockHeader: PFullDebugBlockHeader; const AResult: Integer);
  TOnDebugReallocMemStart = procedure (const AToReallocateFullDebugBlockHeader: PFullDebugBlockHeader; const ANewSize: Integer);
  TOnDebugReallocMemFinish = procedure (const AReallocatedFullDebugBlockHeader: PFullDebugBlockHeader; const ANewSize: Integer);

var
  // note: FastMM will not catch exceptions inside these hooks, so make sure your hook code runs without exceptions
