...
type
  ...
  public
    ...
    class function Compare(a, b: TNullableString): Integer; static;
    class operator Equal(a, b: TNullableString): Boolean;
    class operator Implicit(const A: string): TNullableString;
    class operator NotEqual(a, b: TNullableString): Boolean;
    property IsFilled: Boolean read FIsFilled write SetIsFilled;
    property IsNull: Boolean read GetIsNull write SetIsNull;
...
type
  ...
  public
    procedure Assign(aFillableInt: TNullableBoolean);
    procedure Clear;
    class function Compare(a, b: TNullableBoolean): Integer; static;
    class function Null: TNullableBoolean; static;
    //##jpl: convert to Create Constructor?
    class function Parse(const Value: string): TNullableBoolean; static;
    function ToString: string;
    class operator Equal(const a, b: TNullableBoolean): Boolean;
    class operator Explicit(const a: Variant): TNullableBoolean; overload;
    class operator GreaterThan(const a, b: TNullableBoolean): Boolean;
    class operator GreaterThanOrEqual(const a, b: TNullableBoolean): Boolean;
    class operator LessThan(const a, b: TNullableBoolean): Boolean;
    class operator LessThanOrEqual(const a, b: TNullableBoolean): Boolean;
    class operator NotEqual(const a, b: TNullableBoolean): Boolean;
    property IsFilled: Boolean read FIsFilled write SetIsFilled;
    property IsNull: Boolean read GetIsNull write SetIsNull;
...
begin
  Self.Clear();
  if aValue <> NullAsStringValue then // to prevent filled value for empty string
    try
...
begin
  if Sign = NullAsStringValue then
...
//      Result.Clear;
//    end;
  end; // if Value <> NullAsStringValue
end;
...
function TNullableDateTime.ToLongDayName: string;
var
  WeekDay: Integer;
...
function TNullableDateTime.ToString(const DateTimeFormat: TDateTimeFormat): string;
var
  FormatSettings: TFormatSettings;
begin
  FormatSettings := TFormatSettings.GetLocaleFormatSettings();
  Result := ToString(FormatSettings, DateTimeFormat);
end;
...
begin
  FIsFilled := False;
  FValue := NullAsStringValue;
end;

class function TNullableString.Compare(a, b: TNullableString): Integer;
begin
  if a.IsFilled then
  begin
    if b.IsFilled then
...
class operator TNullableString.Implicit(const A: string): TNullableString;
begin
  Result.Value := A;
end;

procedure TNullableString.SetIsFilled(const Value: Boolean);
begin
  FIsFilled := Value;
  if not IsFilled then
    Clear();
...
procedure TNullableString.SetIsNull(const Value: Boolean);
begin
  IsFilled := not Value;
end;

procedure TNullableString.SetValue(const Value: string);
begin
  FValue := Value;
  FIsFilled := True;
end;

class operator TNullableString.Equal(a, b: TNullableString): Boolean;
begin
  Result := Compare(a, b) = 0;
end;

class operator TNullableString.NotEqual(a, b: TNullableString): Boolean;
begin
  Result := Compare(a, b) <> 0;
end;
...
procedure TNullableBoolean.Assign(aFillableInt: TNullableBoolean);
begin
  if not aFillableInt.FIsFilled then
    Self.Value := aFillableInt.Value;
end;

procedure TNullableBoolean.Clear;
begin
  FIsFilled := False;
  FValue := False;
end;

class function TNullableBoolean.Compare(a, b: TNullableBoolean): Integer;
begin
  if a.IsFilled then
  begin
    if b.IsFilled then
...
function TNullableBoolean.GetIsNull: Boolean;
begin
  Result := not IsFilled;
end;

class function TNullableBoolean.Null: TNullableBoolean;
begin
  Result.Clear;
end;

class function TNullableBoolean.Parse(const Value: string): TNullableBoolean;
var
  NewValue: Boolean;
begin
  if TryStrToBool(Value, NewValue) then
    Result.Value := NewValue
  else
    Result.Clear();
end;

procedure TNullableBoolean.SetIsFilled(const Value: Boolean);
begin
  FIsFilled := Value;
  if not IsFilled then
    Clear();
...
procedure TNullableBoolean.SetIsNull(const Value: Boolean);
begin
  IsFilled := not Value;
end;

procedure TNullableBoolean.SetValue(const Value: Boolean);
begin
  FValue := Value;
  FIsFilled := True;
end;

function TNullableBoolean.ToString: string;
begin
  if IsFilled then
  begin
    //JR: 17-03-2010 -- ik wil geen -1 en 0 als string, maar "Ja" of "Nee"
...
class operator TNullableBoolean.Equal(const a, b: TNullableBoolean): Boolean;
begin
  Result := Compare(a, b) = 0;
end;

class operator TNullableBoolean.Explicit(const a: Variant): TNullableBoolean;
begin
  if VarIsNull(a) or VarIsClear(a) then
    Result.Clear
  else
...
class operator TNullableBoolean.GreaterThan(const a, b: TNullableBoolean): Boolean;
begin
  Result := Compare(a, b) > 0;
end;

class operator TNullableBoolean.GreaterThanOrEqual(const a, b: TNullableBoolean): Boolean;
begin
  Result := Compare(a, b) >= 0;
end;

class operator TNullableBoolean.LessThan(const a, b: TNullableBoolean): Boolean;
begin
  Result := Compare(a, b) < 0;
end;

class operator TNullableBoolean.LessThanOrEqual(const a, b: TNullableBoolean): Boolean;
begin
  Result := Compare(a, b) <= 0;
end;

class operator TNullableBoolean.NotEqual(const a, b: TNullableBoolean): Boolean;
begin
  Result := Compare(a, b) <> 0;
end;
