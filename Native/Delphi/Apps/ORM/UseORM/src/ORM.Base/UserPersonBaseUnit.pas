...
procedure TUserPersonListBase.FillDeleteQueryRecordList(const DeleteQueryRecordList: TEntityQueryRecordList);
var
...
procedure TUserPersonListBase.FillInsertQueryRecordList(const InsertQueryRecordList: TEntityQueryRecordList);
var
...
procedure TUserPersonListBase.FillUpdateQueryRecordList(const UpdateQueryRecordList: TEntityQueryRecordList);
var
