{ MD5.Pas - components for calculating MD5 Message-Digest values
  ...
  preliminary Unicode support: 20100803 - Jeroen Pluimers (note: uses UTF8-encoding for strings, needs to change to a specific Encoding)
}
{.$define UsePascal}
